...
- Do not add workspace mutation behavior here. Writes, edits, deletes, mkdir, snapshots, forks, merges, upload flows, repo bindings, and other mutable filesystem operations belong in `services/filesystem`.
