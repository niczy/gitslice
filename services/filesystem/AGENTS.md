...
- Mutations should flow through the existing commit/snapshot helpers so workspace metadata, search artifacts, async root promotion, and conflict/diff behavior remain consistent.
