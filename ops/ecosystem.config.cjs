...
function buildCoreEnv(target, fileEnv) {
  ...
  return {
    ...
    WORKOS_CLIENT_ID: fileEnv.WORKOS_CLIENT_ID || "",
    WORKOS_API_KEY: fileEnv.WORKOS_API_KEY || "",
    WORKOS_REDIRECT_URI: fileEnv.WORKOS_REDIRECT_URI || "",
    WORKOS_JWKS_URL: fileEnv.WORKOS_JWKS_URL || "",
    WORKOS_COOKIE_PASSWORD: fileEnv.WORKOS_COOKIE_PASSWORD || "",
    WORKOS_AUTHKIT_DOMAIN: fileEnv.WORKOS_AUTHKIT_DOMAIN || "",
    WORKOS_WEBHOOK_SECRET: fileEnv.WORKOS_WEBHOOK_SECRET || "",
