...
func printAgentHelp() {
	...
	fmt.Println("  list       List local agent runners")
	fmt.Println("  input      Send input to an agent session")
	fmt.Println("  interrupt  Interrupt an agent session")
	fmt.Println("  stop       Stop an agent session or local agent runner")
	fmt.Println("\nExamples:")
	fmt.Println("  gs agent list --json")
	fmt.Println("  gs agent start --dir ~/gitslice-agents --agent all --json")
	fmt.Println("  gs agent run --dir ~/gitslice-agents --agent codex,claude")
	fmt.Println("  gs agent run --dir ~/gitslice-agents --agent claude")
	fmt.Println("  gs agent run --dir ~/gitslice-agents -- ./my-agent-script")
	fmt.Println("  gs agent stop --runner agr_123")
	fmt.Println("  gs agent stop --dir ~/gitslice-agents")
...
func printSliceHelp() {
	...
	fmt.Println("  gs slice visibility set nic/ui-refresh public --json")
...
func printChangesetHelp() {
	...
	fmt.Println("  snapshots List snapshot versions for a changeset")
	...
	fmt.Println("  switch    Switch local checkout overlay to a changeset snapshot")
	...
	fmt.Println("  gs changeset snapshots --json")
	fmt.Println("  gs changeset switch --snapshot 2")
...
func printFilesystemHelp() {
	...
	fmt.Println("  visibility   Inspect inherited slice visibility for an absolute home path")
...
func printSliceVisibilityHelp() {
	...
	fmt.Println("  set     Update a slice visibility")
	fmt.Println("\nExamples:")
	fmt.Println("  gs slice visibility get nic/ui-refresh --json")
	fmt.Println("  gs slice visibility set nic/ui-refresh public --json")
...
func printFilesystemVisibilityHelp() {
	...
	fmt.Println("All visibility commands support --json.")
	fmt.Println("\nCommands:")
	fmt.Println("  get     Show the containing slice visibility for an absolute home path")
	fmt.Println("  set     Removed; use gs slice visibility set")
	fmt.Println("\nExamples:")
	fmt.Println("  gs fs visibility get /nic/app/config.json --json")
	fmt.Println("  gs slice visibility set nic/ui-refresh public --json")
}
